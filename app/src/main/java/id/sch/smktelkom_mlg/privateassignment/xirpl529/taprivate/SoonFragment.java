...
public class SoonFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) getView().findViewById(R.id.soon_recyclerView);
    ...
    private void downloadDataPopular() {
        String url = "https://api.themoviedb.org/3/movie/upcoming?api_key=68004564c00d30019ea0a99012a0cfe4";
